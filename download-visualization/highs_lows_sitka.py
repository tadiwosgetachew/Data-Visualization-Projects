...
#ax.set_xlim(datetime(2014, 1, 1), datetime(2014, 12, 31)) # limits the x-axis to 2014

plt.tick_params(axis = "both", which = "major", labelsize =16)

fig.text(0.5, 0.01, 'Source: Sitka Weather Data, 2014', ha='center', fontsize=12)
